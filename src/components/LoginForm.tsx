...
export default function LoginForm({ onSubmit, onBack }) {
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: '#94a3b8' }}>Welcome back</p>
        ...
        <div>
          ...
          <div className="flex justify-end mt-2">
            <button
              ...
              className="text-xs underline transition-colors hover:text-slate-700"
              style={{ color: '#64748b' }}
            >
              Forgot password?
            </button>
